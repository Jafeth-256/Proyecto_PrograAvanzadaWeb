...
namespace Proyecto_ProgaAvanzadaWeb_API.Services
{
    public interface IUsuarioService
    {
        ...
        Task<ResponseDTO<bool>> ActualizarUsuarioCompleto(long idUsuario, ActualizarUsuarioCompletoDTO dto);
        Task<ResponseDTO<EstadisticasUsuariosDTO>> ObtenerEstadisticas();
    }
}